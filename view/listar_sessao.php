    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="row" style="margin-top:150px!important;">
                ...
                <div class="col-md-6 col-lg-6"><h2>Sessões</h2></div>
                <div class="col-md-6 col-lg-6 text-right">
                    <a href="inserir_sessao.php" class="btn btn-primary">Adicionar</a>
                </div>
                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col">Público Lotação</th>
                                    <th scope="col">Filme</th>
                                    <th scope="col">Cinema</th>
                                    <th scope="col"></th>
                                </tr>
                            </thead>
                            <?php $sessoes = getSessaoController(); ?>
                            <?php foreach ($sessoes as $sessao): ?>

                            <tbody>
                                <tr>
                                    <?php $date = new DateTime($sessao['Horário']); $new_date_format = $date->format('H:i:s d-m-Y');?>
                                    <td scope="row"><?php echo $new_date_format; ?></td>
                                    <td><?php echo $sessao['Público_Lotação']; ?></td>
                                    <td><?php echo $sessao['Título_Português']; ?></td>
                                    ...
                                    <td>
                                        ...
                                        <div class="px-1 py-1">
                                            <a href=<?php echo "remover_sessao.php?horario=".$sessao['Horário']."&Id_Cinema=".$sessao['Id_Cinema']; ?> class="btn btn-sm btn-danger">Remover</a>
                                        </div>
