    ...
    <head>
        ...
        <?php
            ...
            if(isset($_GET["Id_Cinema"])){
                $id = $_GET["Id_Cinema"];
                $cinema = getOneCinemasController($id);
            }
                ...
                <div class="col-md-12 col-lg-12" style="margin-top: 20px!important;">
                    ...
                    <form action="../control/cinema_controller.php" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nomeFantasia" name="editar_cinema['Nome_Fantasia']" value="<?php echo $cinema['Nome_Fantasia'] ?>"  placeholder="Nome fantasia">
                        </div>

                        <div class="form-group">
                            <label for="capacidade">Capacidade</label>
                            <input type="text" class="form-control" id="capacidade" name="editar_cinema['Capacidade']" value="<?php echo $cinema['Capacidade'] ?>" placeholder="Capacidade">
                        </div>

                        <div class="form-group">
                            <label for="endereco">Endereço</label>
                            <input type="text" class="form-control" id="endereco" name="editar_cinema['Endereço']" value="<?php echo $cinema['Endereço'] ?>" placeholder="Endereço">
                        </div>
