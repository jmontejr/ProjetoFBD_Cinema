...
<html lang="pt-br">
    ...
    <head>
        ...
        <?php
            ...
            if(isset($_GET["horario"]) and isset($_GET["Id_Cinema"])){
                $horario = $_GET["horario"];
                $id = $_GET["Id_Cinema"];
                $sessao = getOneSessaoController($horario, $id);
            }
                ...
                <div class="col-md-12 col-lg-12" style="margin-top: 20px!important;">
                    ...
                    <form action="../control/sessao_controller.php" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="datetime-local" class="form-control" id="horario" name="editar_sessao['Horário']" value="<?php echo $sessao['Horário'] ?>" placeholder="Horário">
                        </div>

                        <div class="form-group">
                            <label for="publico">Público_Lotação</label>
                            <input type="text" class="form-control" id="publico" name="editar_sessao['Público_Lotação']" value="<?php echo $sessao['Público_Lotação'] ?>" placeholder="Público Lotação">
                        </div>

                        <div class="form-group">
                            <label for="cinema">Cinema</label>
                            <select class="form-control" id="cinema" name="editar_sessao['Id_Cinema']">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="filme" name="editar_sessao['Id_Filme']">
                        ...
                        <div class="row text-center">
                            <div class="px-2">
                                <a href="listar_sessao.php" class="btn btn-danger">Cancelar</a>
                            </div>
                            <div class="px-2">
                                <input type="hidden" name="horario" value="<?php echo $sessao['Horário']; ?>">
                                <input type="hidden" name="id_cinema" value="<?php echo $sessao['Id_Cinema']; ?>">
